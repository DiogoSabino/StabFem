...
for element= 1: size(all_paths,2)
    ...
    switch MODE
        case('Mode:Fluid')
            ...
            if(exist(extracting)~=2) %je n'est pas compris tres bien cette commande; a voir ensemble apres
        ...
        case('Mode:Both')
            ...
            if(exist(extracting2)~=2) %je n'est pas compris tres bien cette commande; a voir ensemble apres
                disp(['Data not calculated for mode: ' extracting]);
            else
